...
public class ClientRepositoryMySQL implements ClientRepository {
    ...
    public List<Client> findAll() {
        ...
        try{  PreparedStatement statement=connection
                .prepareStatement( "Select * from repository_client");
    ...
    public Client findById(Long id) throws EntityNotFoundException {
       /* try {
        ...
        try{  PreparedStatement statement=connection
                .prepareStatement( "Select * from repository_client where id=" + id);
            ResultSet rs=statement.executeQuery();
            if (rs.next()) {
                return getClientFromResultSet(rs);
            } else {
    ...
    public boolean save(Client client) {
        try {
            PreparedStatement insertStatement = connection
                    .prepareStatement("INSERT INTO repository_client values (null, ?, ?, ?, ?, ?)" );
        ...
        try {
            ...
            statement.executeUpdate(sql);*/
             ...
             PreparedStatement removeStatement= connection
                    .prepareStatement("DELETE from account where id >=0" );
    ...
    public void updateClient(Long id, String addressClient) {
            ...
            try {
                PreparedStatement updateStatement = connection
                        .prepareStatement("UPDATE repository_client set addressClient = ? where id = ?");
                updateStatement.setString(1, addressClient);
    ...
    private Client getClientFromResultSet(ResultSet rs) throws SQLException {
        return new ClientBuilder()
                ...
                .setAccount(rs.getLong("idAccount"))
